...
class Gate:
    ...
    def build(self):
        ...
        self.door = g.Rectangle(g.Point(self.point1x, self.point1y), g.Point(self.point2x, self.point2y))
        self.door.setFill('yellow') # red:255, green:255, blue:0
        self.door.draw(self.w)
